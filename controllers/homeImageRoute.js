...
router.post('/uploadhomeimg', upload.array('uploadfile'),function (req, res) {
...
router.get('/gethomeimages',function (req, res) {
    homeImgManager.getAllHomeImgs(function (err, imgs) {
        res.send(imgs);
    })
});

router.post('/deletehomeimages',loginValidator.isAdminLoggedIn,function (req, res) {
