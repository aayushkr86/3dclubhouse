(function($){
    ...
    function krystal_menu_reposive(){
        ...
        if(kt_is_mobile === true){
            $(document).on('click', '.cftech-nav .menu-item-has-children >a', function(e){
                var licurrent = $(this).closest('li');
                var liItem = $('.cftech-nav .menu-item-has-children');
            ...
            $(document).on('click', function(e){
                var target = $( e.target );
                if ( !target.closest('.show-submenu').length || !target.closest('.cftech-nav').length ) {
                    $('.show-submenu').removeClass('show-submenu');
                }
            });
            // On Desktop
        }else{
            $(document).on('mousemove','.cftech-nav .menu-item-has-children',function(){
                $(this).addClass('show-submenu');
                if( $(this).closest('.cftech-nav').hasClass('main-menu')){
                    $('body').addClass('is-show-menu');
                }
            })

            $(document).on('mouseout','.cftech-nav .menu-item-has-children',function(){
